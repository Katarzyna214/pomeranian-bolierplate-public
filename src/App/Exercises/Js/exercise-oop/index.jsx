...
// // ---------------------------------------------------------------------chcemy tylko wybierac imiona reszta uniwersalna ma byc, 'this obiekt user odnosi sie do naszego konkretnego obietu'
// // w zwyklej funkcji this moze sie odniesc do wyzszego obiektu, w funkcji strzalkowej mialby dostep tylko w obrebie tej funkcji
// const user = {
//   name: 'Marcin',
//   sayHello: function () {
...
// user.name = 'Sara'; //modyfikujemy z zewnatrz, zły tip
// user.sayHello(); // console.log --> 'Cześć jestem Sara'
// user.changeName('Szymon'); // nie ingerujemy z zewnatrz
// user.sayHello(); // console.log --> 'Cześć jestem Szymon'
// // ---------------------------------------------------------------------------------------------------------------------------
// //dynamiczna mozliwosc zmiany uzytkownikow
